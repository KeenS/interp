...
#define IP_INST_CONST(v)                                                       \
  {                                                                            \
    IP_CODE_CONST, { v }                                                       \
  }
#define IP_INST_GET_LOCAL(i)                                                   \
  {                                                                            \
    IP_CODE_GET_LOCAL, { i }                                                   \
  }
#define IP_INST_SET_LOCAL(i)                                                   \
  {                                                                            \
    IP_CODE_SET_LOCAL, { i }                                                   \
  }
#define IP_INST_ADD()                                                          \
...
#define IP_INST_JUMP(pos)                                                      \
  {                                                                            \
    IP_CODE_JUMP, { pos }                                                      \
  }
#define IP_INST_JUMP_IF_ZERO(pos)                                              \
  {                                                                            \
    IP_CODE_JUMP_IF_ZERO, { pos }                                              \
  }
#define IP_INST_JUMP_IF_NEG(pos)                                               \
  {                                                                            \
    IP_CODE_JUMP_IF_NEG, { pos }                                               \
  }
#define IP_INST_CALL(p)                                                        \
  {                                                                            \
    IP_CODE_CALL, { p }                                                        \
  }
#define IP_INST_CALL_INDIRECT()                                                \
  {                                                                            \
    IP_CODE_CALL_INDIRECT, {}                                                  \
  }
#define IP_INST_RETURN()                                                       \
  {                                                                            \
    IP_CODE_RETURN, {}                                                         \
  }
#define IP_INST_EXIT()                                                         \
...
void
ip_vm_register_proc_at(struct ip_vm* vm,
                       struct ip_proc* proc,
                       ip_proc_ref_t at);
ip_proc_ref_t
